...
import dev.MinseoKangQ.auth.entity.UserEntity;
import dev.MinseoKangQ.auth.entity.UserRepository;
...
public class CustomUserDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        // userEntity 를 userDetail 로 바꾸기 -> User 객체 이용하기 (User 객체는 UserDetails 의 구현체)
